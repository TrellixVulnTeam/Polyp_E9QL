...
class RPFNHead(BaseDecodeHead):
    ...
    def __init__(self,
        ...
        self.psa_1 = SequentialPolarizedSelfAttention(self.channels)
        self.psa_2 = SequentialPolarizedSelfAttention(self.channels)
        self.psa_3 = SequentialPolarizedSelfAttention(self.channels)
        self.psa_4 = SequentialPolarizedSelfAttention(self.channels)
    ...
    def forward(self, inputs):
        ...
        c3, c4, c5, c6 = feats
        c3 = self._resize(c3, size=c4.shape[-2:])
        c5 = self._resize(c5, size=c4.shape[-2:])
        c6 = self._resize(c6, size=c4.shape[-2:])
        # fixed order
        ...
        p4 = self.RevFP['p4']([c4, c5, p3], out_size=c3.shape[-2:])
        p5 = self.RevFP['p5']([c5, c6, p4], out_size=c3.shape[-2:])
        p6 = self.RevFP['p6']([c6, p5], out_size=c3.shape[-2:])
